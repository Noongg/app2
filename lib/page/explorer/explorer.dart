...
import 'package:test_flutter_app2/controller/controller_explorer.dart';
                            ...
                            children: [
                              CategoryItem(
                                  callback: (){
                                    ...
                                    Get.to(()=>FindProduct(title: 'Fresh Fruits & Vegetable',));
                                  },
                              ...
                              CategoryItem(
                                  callback: (){
                                    ...
                                    Get.to(()=>FindProduct(title: 'Cooking Oil & Ghee',));
                                  },
                            ...
                            children: [
                              CategoryItem(
                                callback: (){
                                  ...
                                  Get.to(()=>FindProduct(title: 'Meat & Fish',));
                                },
                              ...
                              CategoryItem(
                                callback: (){
                                  ...
                                  Get.to(()=>FindProduct(title: 'Bakery & Snacks',));
                                },
                            ...
                            children: [
                              CategoryItem(
                                callback: (){
                                  ...
                                  Get.to(()=>FindProduct(title: 'Dairy & Eggs',));
                                },
                              ...
                              CategoryItem(
                                callback: (){
                                  ...
                                  Get.to(()=>FindProduct(title: 'Beverages',));
                                },
